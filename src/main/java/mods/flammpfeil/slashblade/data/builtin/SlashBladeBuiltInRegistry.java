...
public class SlashBladeBuiltInRegistry {
    ...
    public static void registerAll(BootstrapContext<SlashBladeDefinition> bootstrap) {
        bootstrap.register(KOSEKI,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_koseki"), SlashBlade.prefix("koseki"),
        ...
        bootstrap.register(SABIGATANA,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_sabigatana"), SlashBlade.prefix("sabigatana"),
                        RenderDefinition.Builder
        ...
        bootstrap.register(SABIGATANA_BROKEN, new SlashBladeDefinition(SlashBlade.prefix("slashblade_sabigatana_broken"), SlashBlade.prefix("sabigatana_broken"),
                RenderDefinition.Builder
                        .newInstance().textureName(SlashBlade.prefix("model/named/muramasa/sabigatana.png"))
                        .modelName(SlashBlade.prefix("model/named/muramasa/muramasa.obj"))
                        .standbyRenderType(CarryType.PSO2)
        ...
        bootstrap.register(DOUTANUKI,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_doutanuki"), SlashBlade.prefix("doutanuki"),
        ...
        bootstrap.register(TAGAYASAN,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_tagayasan"), SlashBlade.prefix("tagayasan"),
                        RenderDefinition.Builder.newInstance()
        ...
        bootstrap.register(YASHA, new SlashBladeDefinition(SlashBlade.prefix("slashblade_yasha"), SlashBlade.prefix("yasha"),
        ...
        bootstrap.register(YASHA_TRUE, new SlashBladeDefinition(SlashBlade.prefix("slashblade_yasha_true"), SlashBlade.prefix("yasha_true"),
                RenderDefinition.Builder.newInstance().textureName(SlashBlade.prefix("model/named/yasha/yasha.png"))
        ...
        bootstrap.register(AGITO_RUST, new SlashBladeDefinition(SlashBlade.prefix("slashblade_agito_rust"), SlashBlade.prefix("agito_rust"),
        ...
        bootstrap.register(AGITO, new SlashBladeDefinition(SlashBlade.prefix("slashblade_agito"), SlashBlade.prefix("agito"),
        ...
        bootstrap.register(OROTIAGITO_RUST, new SlashBladeDefinition(SlashBlade.prefix("slashblade_orotiagito_rust"), SlashBlade.prefix("orotiagito_rust"),
        ...
        bootstrap.register(OROTIAGITO_SEALED, new SlashBladeDefinition(SlashBlade.prefix("slashblade_orotiagito_sealed"), SlashBlade.prefix("orotiagito_sealed"),
        ...
        bootstrap.register(OROTIAGITO, new SlashBladeDefinition(SlashBlade.prefix("slashblade_orotiagito"), SlashBlade.prefix("orotiagito"),
        ...
        bootstrap.register(RODAI_WOODEN,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_rodai_wooden"), SlashBlade.prefix("rodai_wooden"),
        ...
        bootstrap.register(RODAI_STONE,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_rodai_stone"), SlashBlade.prefix("rodai_stone"),
        ...
        bootstrap.register(RODAI_IRON,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_rodai_iron"), SlashBlade.prefix("rodai_iron"),
        ...
        bootstrap.register(RODAI_GOLDEN,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_rodai_golden"), SlashBlade.prefix("rodai_golden"),
        ...
        bootstrap.register(RODAI_DIAMOND,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_rodai_diamond"), SlashBlade.prefix("rodai_diamond"),
        ...
        bootstrap.register(RODAI_NETHERITE,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_rodai_netherite"), SlashBlade.prefix("rodai_netherite"),
                        RenderDefinition.Builder.newInstance()
        ...
        bootstrap.register(RUBY,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_ruby"), SlashBlade.prefix("ruby"),
        ...
        bootstrap.register(FOX_BLACK, new SlashBladeDefinition(SlashBlade.prefix("slashblade_fox_black"), SlashBlade.prefix("fox_black"),
        ...
        bootstrap.register(FOX_WHITE, new SlashBladeDefinition(SlashBlade.prefix("slashblade_fox_white"), SlashBlade.prefix("fox_white"),
        ...
        bootstrap.register(YAMATO,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_yamato"), SlashBlade.prefix("yamato"),
        ...
        bootstrap.register(YAMATO_BROKEN,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_yamato_broken"), SlashBlade.prefix("yamato_broken"),
                        RenderDefinition.Builder.newInstance().textureName(SlashBlade.prefix("model/named/yamato.png"))
                                .modelName(SlashBlade.prefix("model/named/yamato.obj"))
                                .standbyRenderType(CarryType.DEFAULT)
                                .build(),
        ...
        bootstrap.register(TUKUMO, new SlashBladeDefinition(SlashBlade.prefix("slashblade_yuzukitukumo"), SlashBlade.prefix("yuzukitukumo"),
        ...
        bootstrap.register(MURAMASA,
                new SlashBladeDefinition(SlashBlade.prefix("slashblade_muramasa"), SlashBlade.prefix("muramasa"),
                        RenderDefinition.Builder
        ...
        bootstrap.register(SANGE, new SlashBladeDefinition(SlashBlade.prefix("slashblade_sange"), SlashBlade.prefix("sange"),
